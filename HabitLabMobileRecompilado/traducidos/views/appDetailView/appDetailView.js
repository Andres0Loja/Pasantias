...
var createItem = function(enabled, id, first)  {
  ...
  button.text = localize('view.appDetailView.button');
  button.className = 'app-detail-disable-button';
  button.on('tap', function() {
    events.push({category: 'features', index: 'watchlist_detail_disable_all'});
    dialogs.confirm({
      title: localize('view.appDetailView.dialog.title'),
      message: localize('view.appDetailView.dialog.message'),
      okButtonText: localize('view.appDetailView.dialog.okButton'),
      cancelButtonText: localize('view.appDetailView.dialog.cancelButton')
